	...
	TrustindexConnect = {
		...
		if (TrustindexConnect.button.length) {
			...
			TrustindexConnect.button.click(function(event) {
				...
				let regex = /capterra\.((?:com\.ar|com\.au|jp|be|com\.br|ca|cl|co|co\.cr|dk|com\.de|ec|es|fr|in|ie|co\.il|lu|it|mx|nl|at|com\.pa|no|pe|pl|pt|do|ch|com\.sg|co\.za|fi|se|web\.tr|ae|co\.uk|com)\/(?:software|p)(?:[^?#]+))/;
				...
				div.find('img').attr('src', 'https://cdn.trustindex.io/assets/platform/Capterra/icon.png');
