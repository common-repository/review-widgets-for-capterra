...
$stepList = [
sprintf(__('Connect %s', 'trustindex-plugin'), 'Capterra'),
...
<h1 class="ti-header-title"><?php echo sprintf(__('Connect %s', 'trustindex-plugin'), 'Capterra'); ?></h1>
...
<?php else: ?>
<div class="ti-box">
<form method="post" action="" data-platform="capterra" id="ti-connect-platform-form">
...
$labelText = sprintf(__('%s Business URL', 'trustindex-plugin'), 'Capterra');
$infoText = __("Type your business/company's URL and select from the list", 'trustindex-plugin');
$errorText = sprintf(__('Please add your URL again: this is not a valid %s page.', 'trustindex-plugin'), "Capterra");
...
<?php endif; ?>
<h1 class="ti-header-title ti-mt-2"><?php echo sprintf(__('Check some %s widget layouts and styles', 'trustindex-plugin'), 'Capterra reviews'); ?></h1>
...
<p>
<?php echo sprintf(__('There are no reviews on your %s platform.', 'trustindex-plugin'), 'Capterra'); ?>
</p>
</div>
<?php endif; ?>
...
<?php endif; ?>
<?php
$tiCampaign1 = 'wp-capterra-1';
$tiCampaign2 = 'wp-capterra-2';
